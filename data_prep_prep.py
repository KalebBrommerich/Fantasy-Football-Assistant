...
files_and_years = [
    (r'2018/passing.csv', 2018),
    (r'2018/rushing.csv', 2018),
    (r'2018/receiving.csv', 2018),
    (r'2019/passing.csv', 2019),
    (r'2019/rushing.csv', 2019),
    (r'2019/receiving.csv', 2019),
    (r'2020/passing.csv', 2020),
    (r'2020/rushing.csv', 2020),
    (r'2020/receiving.csv', 2020),
    (r'2021/passing.csv', 2021),
    (r'2021/rushing.csv', 2021),
    (r'2021/receiving.csv', 2021),
    (r'2022/passing.csv', 2022),
    (r'2022/rushing.csv', 2022),
    (r'2022/receiving.csv', 2022),
    (r'2023/passing.csv', 2023),
    (r'2023/rushing.csv', 2023),
    (r'2023/receiving.csv', 2023)
]
# List of file paths and corresponding years
files_and_years2 = [
    (r'2012/passing.csv', 2012),
    (r'2012/rushing.csv', 2012),
    (r'2012/receiving.csv', 2012),
    (r'2013/passing.csv', 2013),
    (r'2013/rushing.csv', 2013),
    (r'2013/receiving.csv', 2013),
    (r'2014/passing.csv', 2014),
    (r'2014/rushing.csv', 2014),
    (r'2014/receiving.csv', 2014),
    (r'2015/passing.csv', 2015),
    (r'2015/rushing.csv', 2015),
    (r'2015/receiving.csv', 2015),
    (r'2016/passing.csv', 2016),
    (r'2016/rushing.csv', 2016),
    (r'2016/receiving.csv', 2016),
    (r'2017/passing.csv', 2017),
    (r'2017/rushing.csv', 2017),
    (r'2017/receiving.csv', 2017)
]
